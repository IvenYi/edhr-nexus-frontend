...
--changeset edhr:0087-restore-standard-material-types
--validCheckSum: 9:040ba27135010abf5f2377194896d24c
...
WHERE NOT EXISTS (
    SELECT 1 FROM material_type mt WHERE mt.tenant_id = 'default' AND (mt.name = v.name OR mt.code = v.code)
);
