<template>
  <FieldDateTimePicker
    :class="['field-datetimepicker', { 'is-out-of-range': outOfRange }]"
    v-model="value"
    :label="showFieldName"
...
<script setup lang="ts" name="online-form-datetimepicker-field-render">
  import { reactive } from 'vue';
  import { useNocodeFormWidget, type IDateTimepicker } from '@gct/nocode-base';
  import { FieldDateTimePicker, FieldTypeIcon } from '../../_common_';
  import { useMobileAttrs } from '../../../hooks';
  import { useRangeValidate } from '../datepicker/hooks/useRangeValidate';
