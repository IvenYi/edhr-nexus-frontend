<template>
  <div
    :class="['checkbox-cell-comp-field-mobile', realFieldId, { 'is-disabled': showDisabled }]"
    role="group"
  >
    <span
    ...
    >
      <span class="indicator" aria-hidden="true">
        <svg
          ...
          aria-hidden="true"
        >
          <path fill="currentColor" d="M9.2 16.2L4.9 12l-1.1 1.1L9.2 18.4 21.2 6.4 20.1 5.3z" />
        </svg>
      </span>
...
<script setup lang="ts" name="checkbox-cell-comp-field">
...
<style scoped lang="less">
  .checkbox-cell-comp-field-mobile {
    display: inline-flex;
    flex-wrap: nowrap;
    gap: 4px;
    align-items: center;
