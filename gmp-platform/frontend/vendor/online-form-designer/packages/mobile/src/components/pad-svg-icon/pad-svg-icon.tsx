 ...
 *
 * // 使用 src 属性
 * <PadSvgIcon src="/path/to/icon.svg" />
 *
 * // 设置大小和颜色
 * <PadSvgIcon src="/path/to/icon.svg" size="large" color="primary" />
 *
 * // RTL 支持
 * <PadSvgIcon src="/path/to/icon.svg" flipRtl={true} />
 *
 * // 懒加载
 * <PadSvgIcon src="/path/to/icon.svg" lazy={true} />
 *
 * // 禁用 SVG 清理
 * <PadSvgIcon src="/path/to/icon.svg" sanitize={false} />
 */
export const PadSvgIcon = defineComponent({
  name: 'PadSvgIcon',
  props: {
    /**
  ...
  setup(props) {
    const ns = useNamespace('pad-svg-icon');
