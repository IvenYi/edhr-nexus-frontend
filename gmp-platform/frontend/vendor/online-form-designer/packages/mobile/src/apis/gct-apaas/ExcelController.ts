...
import type { ResponseEntityobject, ResponseEntityImportModelData, ResponseEntity, ResponseEntityExcelValidateResponse } from './model/index';
...
export async function getExcelDataDoImport(params: getExcelDataDoImportQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityobject['data']> {
  return request(
    {
...
export async function getExcelDataExport(params: getExcelDataExportQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<any> {
  return request(
    {
...
export async function postExcelDataImport(params: postExcelDataImportQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityobject['data']> {
  return request(
    {
...
export async function getExcelDataPreview(params: getExcelDataPreviewQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityImportModelData['data']> {
  return request(
    {
...
export async function getExcelDataReport(params: getExcelDataReportQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntity['data']> {
  return request(
    {
...
export async function postExcelDataValidate(params: postExcelDataValidateQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityExcelValidateResponse['data']> {
  return request(
    {
