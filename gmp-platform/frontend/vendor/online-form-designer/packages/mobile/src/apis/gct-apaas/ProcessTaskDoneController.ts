...
import type { ProcessTaskApproveHisQueryRequest, ResponseEntityPageBaseProcessTaskDoneApproveHisResponse, ResponseEntityPageBaseProcessTaskDoneResponse } from './model/index';
 ...
 */
export async function postProcessTaskDoneApproveHisPageList(data: ProcessTaskApproveHisQueryRequest, config:AxiosRequestConfig = {}): Promise<ResponseEntityPageBaseProcessTaskDoneApproveHisResponse['data']> {
  return request(
    {
...
export async function getProcessTaskDonePageList(params: getProcessTaskDonePageListQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityPageBaseProcessTaskDoneResponse['data']> {
  return request(
    {
