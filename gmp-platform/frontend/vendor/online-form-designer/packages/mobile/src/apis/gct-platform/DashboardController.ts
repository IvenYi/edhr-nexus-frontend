...
/**
 * 删除
 * import { deleteDashboard } from "/@/apis/gct-platform/DashboardController"
 */
...
/**
 * 详情
 * import { getDashboardInfo } from "/@/apis/gct-platform/DashboardController"
 */
...
export async function getDashboardInfo(params: getDashboardInfoQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityDashboardResponse['data']> {
  return request(
    {
      url: `/gct-platform/api/dashboard/info`,
      method: 'get',
      params,
      ...config,
    },
...
/**
 * 列表
 * import { getDashboardList } from "/@/apis/gct-platform/DashboardController"
 */
...
export async function getDashboardList(params: getDashboardListQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityListDashboardResponse['data']> {
  return request(
    {
      url: `/gct-platform/api/dashboard/list`,
      method: 'get',
      params,
      ...config,
    },
...
/**
 * 移动位置
 * import { postDashboardMove } from "/@/apis/gct-platform/DashboardController"
 */
export async function postDashboardMove(data: DashboardSortRequest, config:AxiosRequestConfig = {}): Promise<ResponseEntitystring['data']> {
  return request(
    {
      url: `/gct-platform/api/dashboard/move`,
      method: 'post',
      data,
      ...config,
    },
...
/**
 * 分页列表
 * import { getDashboardPageList } from "/@/apis/gct-platform/DashboardController"
 */
...
export async function getDashboardPageList(params: getDashboardPageListQueryInterface = {}, config:AxiosRequestConfig = {}): Promise<ResponseEntityPageBaseDashboardResponse['data']> {
  return request(
    {
      url: `/gct-platform/api/dashboard/page/list`,
      method: 'get',
      params,
      ...config,
    },
...
/**
 * 修改
 * import { putDashboardById } from "/@/apis/gct-platform/DashboardController"
 */
...
export async function putDashboardById(path: putDashboardByIdPathInterface, data: DashboardRequest, config:AxiosRequestConfig = {}): Promise<ResponseEntitystring['data']> {
  return request(
    {
      url: `/gct-platform/api/dashboard/${path?.id}`,
      method: 'put',
      data,
      ...config,
    },
