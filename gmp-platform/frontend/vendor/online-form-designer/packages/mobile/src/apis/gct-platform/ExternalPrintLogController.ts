...
import type { PrintLogRequest, ResponseEntitystring, ResponseEntityPrintLogResponse, ResponseEntityListPrintLogResponse, ResponseEntityPageBasePrintLogResponse, PrintLogSearchRequest } from './model/index';
...
/**
 * 分页列表
 * import { postPrintLogPageList } from "/@/apis/gct-platform/ExternalPrintLogController"
 */
