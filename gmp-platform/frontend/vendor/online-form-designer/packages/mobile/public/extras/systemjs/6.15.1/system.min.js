...
/*!
 * SystemJS named-register 6.15.1
 */
 ...
 */
(function(p){typeof define=="function"&&define.amd?define(p):p()})(function(){"use strict";function p(f){return f&&f.__esModule&&Object.prototype.hasOwnProperty.call(f,"default")?f.default:f}var w,M;function J(){if(M)return w;M=1;var f={default:w,call:function(a,s,u){var n="";typeof s=="function"&&(u=s,s={});var e={data:s===void 0?null:s};if(typeof u=="function"){var r="dscb"+window.dscb++;window[r]=u,e._dscbstub=r}return e=JSON.stringify(e),window._dsbridge?n=_dsbridge.call(a,e):(window._dswk||navigator.userAgent.indexOf("_dsbridge")!=-1)&&(n=prompt("_dsbridge="+a,e)),JSON.parse(n||"{}").data},register:function(a,s,u){var n=u?window._dsaf:window._dsf;window._dsInit||(window._dsInit=!0,setTimeout(function(){f.call("_dsb.dsinit")},0)),typeof s=="object"?n._obs[a]=s:n[a]=s},registerAsyn:function(a,s){this.register(a,s,!0)},hasNativeMethod:function(a,s){return this.call("_dsb.hasNativeMethod",{name:a,type:s||"all"})},disableJavascriptDialogBlock:function(a){this.call("_dsb.disableJavascriptDialogBlock",{disable:a!==!1})}};return function(){if(!window._dsf){var a={_dsf:{_obs:{}},_dsaf:{_obs:{}},dscb:0,dsBridge:f,close:function(){f.call("_dsb.closePage")},_handleMessageFromNative:function(u){var n=JSON.parse(u.data),e={id:u.callbackId,complete:!0},r=this._dsf[u.method],t=this._dsaf[u.method],i=function(m,b){e.data=m.apply(b,n),f.call("_dsb.returnValue",e)},o=function(m,b){n.push(function(y,V){e.data=y,e.complete=V!==!1,f.call("_dsb.returnValue",e)}),m.apply(b,n)};if(r)i(r,this._dsf);else if(t)o(t,this._dsaf);else{var l=u.method.split(".");if(l.length<2)return;var c=l.pop(),v=l.join("."),g=this._dsf._obs,h=g[v]||{},d=h[c];if(d&&typeof d=="function"){i(d,h);return}if(g=this._dsaf._obs,h=g[v]||{},d=h[c],d&&typeof d=="function"){o(d,h);return}}}};for(var s in a)window[s]=a[s];f.register("_hasJavascriptMethod",function(u,n){var e=u.split(".");if(e.length<2)return!!(_dsf[e]||_dsaf[e]);var u=e.pop(),r=e.join("."),t=_dsf._obs[r]||_dsaf._obs[r];return t&&!!t[u]})}}(),w=f,w}var F=J(),N=p(F),L=(f,a,s)=>new Promise((u,n)=>{var e=i=>{try{t(s.next(i))}catch(o){n(o)}},r=i=>{try{t(s.throw(i))}catch(o){n(o)}},t=i=>i.done?u(i.value):Promise.resolve(i.value).then(e,r);t((s=s.apply(f,a)).next())});class B{static init(){System.constructor.prototype.shouldFetch=function(){return!0},System.constructor.prototype.fetch=a=>L(this,null,function*(){if(a.startsWith("file:"))try{let s;const u=yield new Promise(n=>{N.call("FILE.readLocalFile",{path:a},function(e){const{data:r}=JSON.parse(e);n(r)})});return{ok:!0,status:200,headers:{get(n){if(n==="content-type")return"application/javascript";throw Error(`NodeJS fetch emulation doesn't support ${n} header`)}},text(){return L(this,null,function*(){return u})},json(){return L(this,null,function*(){return JSON.parse(u)})}}}catch(s){return s.code==="ENOENT"?{status:404,statusText:s.toString()}:{status:500,statusText:s.toString()}}else return fetch(a)})}}var E,D;function O(){if(D)return E;D=1;function f(n){if(typeof n!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(n))}function a(n,e){for(var r="",t=0,i=-1,o=0,l,c=0;c<=n.length;++c){if(c<n.length)l=n.charCodeAt(c);else{if(l===47)break;l=47}if(l===47){if(!(i===c-1||o===1))if(i!==c-1&&o===2){if(r.length<2||t!==2||r.charCodeAt(r.length-1)!==46||r.charCodeAt(r.length-2)!==46){if(r.length>2){var v=r.lastIndexOf("/");if(v!==r.length-1){v===-1?(r="",t=0):(r=r.slice(0,v),t=r.length-1-r.lastIndexOf("/")),i=c,o=0;continue}}else if(r.length===2||r.length===1){r="",t=0,i=c,o=0;continue}}e&&(r.length>0?r+="/..":r="..",t=2)}else r.length>0?r+="/"+n.slice(i+1,c):r=n.slice(i+1,c),t=c-i-1;i=c,o=0}else l===46&&o!==-1?++o:o=-1}return r}function s(n,e){var r=e.dir||e.root,t=e.base||(e.name||"")+(e.ext||"");return r?r===e.root?r+t:r+n+t:t}var u={resolve:function(){for(var e="",r=!1,t,i=arguments.length-1;i>=-1&&!r;i--){var o;i>=0?o=arguments[i]:(t===void 0&&(t=process.cwd()),o=t),f(o),o.length!==0&&(e=o+"/"+e,r=o.charCodeAt(0)===47)}return e=a(e,!r),r?e.length>0?"/"+e:"/":e.length>0?e:"."},normalize:function(e){if(f(e),e.length===0)return".";var r=e.charCodeAt(0)===47,t=e.charCodeAt(e.length-1)===47;return e=a(e,!r),e.length===0&&!r&&(e="."),e.length>0&&t&&(e+="/"),r?"/"+e:e},isAbsolute:function(e){return f(e),e.length>0&&e.charCodeAt(0)===47},join:function(){if(arguments.length===0)return".";for(var e,r=0;r<arguments.length;++r){var t=arguments[r];f(t),t.length>0&&(e===void 0?e=t:e+="/"+t)}return e===void 0?".":u.normalize(e)},relative:function(e,r){if(f(e),f(r),e===r||(e=u.resolve(e),r=u.resolve(r),e===r))return"";for(var t=1;t<e.length&&e.charCodeAt(t)===47;++t);for(var i=e.length,o=i-t,l=1;l<r.length&&r.charCodeAt(l)===47;++l);for(var c=r.length,v=c-l,g=o<v?o:v,h=-1,d=0;d<=g;++d){if(d===g){if(v>g){if(r.charCodeAt(l+d)===47)return r.slice(l+d+1);if(d===0)return r.slice(l+d)}else o>g&&(e.charCodeAt(t+d)===47?h=d:d===0&&(h=0));break}var m=e.charCodeAt(t+d),b=r.charCodeAt(l+d);if(m!==b)break;m===47&&(h=d)}var y="";for(d=t+h+1;d<=i;++d)(d===i||e.charCodeAt(d)===47)&&(y.length===0?y+="..":y+="/..");return y.length>0?y+r.slice(l+h):(l+=h,r.charCodeAt(l)===47&&++l,r.slice(l))},_makeLong:function(e){return e},dirname:function(e){if(f(e),e.length===0)return".";for(var r=e.charCodeAt(0),t=r===47,i=-1,o=!0,l=e.length-1;l>=1;--l)if(r=e.charCodeAt(l),r===47){if(!o){i=l;break}}else o=!1;return i===-1?t?"/":".":t&&i===1?"//":e.slice(0,i)},basename:function(e,r){if(r!==void 0&&typeof r!="string")throw new TypeError('"ext" argument must be a string');f(e);var t=0,i=-1,o=!0,l;if(r!==void 0&&r.length>0&&r.length<=e.length){if(r.length===e.length&&r===e)return"";var c=r.length-1,v=-1;for(l=e.length-1;l>=0;--l){var g=e.charCodeAt(l);if(g===47){if(!o){t=l+1;break}}else v===-1&&(o=!1,v=l+1),c>=0&&(g===r.charCodeAt(c)?--c===-1&&(i=l):(c=-1,i=v))}return t===i?i=v:i===-1&&(i=e.length),e.slice(t,i)}else{for(l=e.length-1;l>=0;--l)if(e.charCodeAt(l)===47){if(!o){t=l+1;break}}else i===-1&&(o=!1,i=l+1);return i===-1?"":e.slice(t,i)}},extname:function(e){f(e);for(var r=-1,t=0,i=-1,o=!0,l=0,c=e.length-1;c>=0;--c){var v=e.charCodeAt(c);if(v===47){if(!o){t=c+1;break}continue}i===-1&&(o=!1,i=c+1),v===46?r===-1?r=c:l!==1&&(l=1):r!==-1&&(l=-1)}return r===-1||i===-1||l===0||l===1&&r===i-1&&r===t+1?"":e.slice(r,i)},format:function(e){if(e===null||typeof e!="object")throw new TypeError('The "pathObject" argument must be of type Object. Received type '+typeof e);return s("/",e)},parse:function(e){f(e);var r={root:"",dir:"",base:"",ext:"",name:""};if(e.length===0)return r;var t=e.charCodeAt(0),i=t===47,o;i?(r.root="/",o=1):o=0;for(var l=-1,c=0,v=-1,g=!0,h=e.length-1,d=0;h>=o;--h){if(t=e.charCodeAt(h),t===47){if(!g){c=h+1;break}continue}v===-1&&(g=!1,v=h+1),t===46?l===-1?l=h:d!==1&&(d=1):l!==-1&&(d=-1)}return l===-1||v===-1||d===0||d===1&&l===v-1&&l===c+1?v!==-1&&(c===0&&i?r.base=r.name=e.slice(1,v):r.base=r.name=e.slice(c,v)):(c===0&&i?(r.name=e.slice(1,l),r.base=e.slice(1,v)):(r.name=e.slice(c,l),r.base=e.slice(c,v)),r.ext=e.slice(l,v)),c>0?r.dir=e.slice(0,c-1):i&&(r.dir="/"),r},sep:"/",delimiter:":",win32:null,posix:null};return u.posix=u,E=u,E}var T=O(),A=p(T),j=Object.defineProperty,q=(f,a,s)=>a in f?j(f,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):f[a]=s,P=(f,a,s)=>(q(f,typeof a!="symbol"?a+"":a,s),s),x=(f,a,s)=>new Promise((u,n)=>{var e=i=>{try{t(s.next(i))}catch(o){n(o)}},r=i=>{try{t(s.throw(i))}catch(o){n(o)}},t=i=>i.done?u(i.value):Promise.resolve(i.value).then(e,r);t((s=s.apply(f,a)).next())});class k{constructor(a){P(this,"baseDir"),P(this,"styleElementMap",new Map),P(this,"url"),P(this,"regex",/^https?:\/\//),this.url=this.regex.test(a)?new URL(a):new URL(a,A.join(location.origin,location.pathname));const s=A.dirname(this.url.pathname);this.baseDir=s}dir(a){return this.regex.test(a)?a:A.resolve(this.baseDir,a)}loadStyle(a){return x(this,null,function*(){const s=a.map(u=>{const n=this.dir(u);return this.styleElementMap.has(n)?!1:(this.styleElementMap.set(n,null),new Promise((e,r)=>{const t=document.createElement("link");t.setAttribute("type","text/css"),t.setAttribute("rel","stylesheet"),t.setAttribute("href",n),t.onload=e,t.onerror=r,document.head.appendChild(t)}))});yield Promise.all(s)})}}var I=Object.defineProperty,$=(f,a,s)=>a in f?I(f,a,{enumerable:!0,configurable:!0,writable:!0,value:s}):f[a]=s,S=(f,a,s)=>($(f,typeof a!="symbol"?a+"":a,s),s),C=(f,a,s)=>new Promise((u,n)=>{var e=i=>{try{t(s.next(i))}catch(o){n(o)}},r=i=>{try{t(s.throw(i))}catch(o){n(o)}},t=i=>i.done?u(i.value):Promise.resolve(i.value).then(e,r);t((s=s.apply(f,a)).next())});const _=class R{static addImportStyleMap(a,s){const u=new k(a);this.map.set(u,s)}static init(){const a=this,s=System.constructor.prototype.resolve;System.constructor.prototype.resolve=function(n,e){return Promise.resolve(s.call(this,n,e)).then(r=>C(this,null,function*(){return r&&(yield a.loadStyle(n)),r}))};const u=System.constructor.prototype.addImportMap;System.constructor.prototype.addImportMap=function(n){u.call(this,n),n.styles&&R.addImportStyleMap(A.join(location.origin,location.pathname),n.styles)}}static loadStyle(a){return C(this,null,function*(){this.isLoaded===!1&&(this.isLoaded=!0,this.configLoadPromise=this.resolveConfig()),this.configLoadPromise&&(yield this.configLoadPromise);const s=[];this.map.forEach((u,n)=>{const e=u[a];e&&(Array.isArray(e)?s.push(n.loadStyle(e)):s.push(n.loadStyle([e])))}),yield Promise.all(s)})}static resolveConfig(){return C(this,null,function*(){const a=document.querySelectorAll("script"),u=Array.from(a).map(n=>C(this,null,function*(){if(n.type==="systemjs-importmap"){const e=yield System.constructor.prototype.fetch(n.src);if(e.ok){const r=yield e.json();if(r.styles){const t=new k(n.src);this.map.set(t,r.styles)}}}}));yield Promise.all(u),this.configLoadPromise&&(this.configLoadPromise=null)})}};S(_,"map",new Map),S(_,"styleElementMap",new Map),S(_,"configLoadPromise",null),S(_,"isLoaded",!1);let z=_;B.init(),z.init()});
