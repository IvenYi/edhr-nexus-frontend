...
export function getIpadConfig(mode: string) {
  ...
  return {
    ...
    plugins: [
      ...
      compresssionBuild({
        sourceName: `../../dist/build/src/projects/ipad-render`,
        type: 'zip',
        targetName: `../../dist/build/src/projects/ipad`,
        ignoreBase: true,
      }),
    ],
    resolve: {
    ...
    build: {
      outDir: '../../dist/build/src/projects/ipad-render/dist',
    },
    server: {
      port: 9999,
      host: true,
