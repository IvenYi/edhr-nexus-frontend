...
export namespace GctBpmnNode {
  ...
  export interface BpmnEndWithListener extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnEndWithListener;
    data?: IGctBpmnNodeDefinition;
  }
  ...
  export interface BpmnBizDocument extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnBizDocument;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnAllocat extends IGctBpmnNode {
  ...
  export interface BpmnIPassFlow extends IGctBpmnNode {
  ...
  export interface BpmnParallelReal extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnParallelReal;
    data?: IGctBpmnNodeDefinition;
    children: Array<
      GctFlowNode.Basic & {
        type: FlowNodeTypeEnum.Flow;
  ...
  export interface BpmnInBound extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnInBound;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnOutBound extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnOutBound;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnInspection extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnInspection;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnRelease extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnRelease;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnMaterialUnLoading extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnMaterialUnLoading;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnMaterialLoading extends IGctBpmnNode {
    type: BpmnNodeTypeEnum.BpmnMaterialLoading;
    data?: IGctBpmnNodeDefinition;
  }

  export interface BpmnLabelPrint extends IGctBpmnNode {
