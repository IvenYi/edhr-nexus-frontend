...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const scrollHeight = computed((): CSSProperties => {
        const modalheight = window.innerHeight * 0.88 - 120;
        return {
          height: `${props.height ? (modalheight > props.height - 120 ? props.height - 120 : modalheight) : props.height}px`,
        };
      });

      // const spinStyle = computed((): CSSProperties => {
      //   const modalheight = window.innerHeight * 0.88 - 152;
      //   return {
      //     height: `${props.height ? (modalheight > props.height - 152 ? props.height - 152 : modalheight) : props.height}px`,
      //     minHeight: `${props.minHeight - 152}px`,
      ...
      const observer = new ResizeObserver((entries) => {
        for (let entry of entries) {
          ...
          const modalheight = height * 0.88 - 152;
          spinStyle.value = {
            height: `${props.height ? (modalheight > props.height - 152 ? props.height - 152 : modalheight) : props.height}px`,
            minHeight: `${props.minHeight - 152}px`,
      ...
      return { wrapperRef, spinRef, spinStyle, scrollTop, setModalHeight, scrollHeight };
    },
  });
</script>
