<template>
  <Tooltip placement="top">
    <template #title>
      <span>{{ t('sys.component.table.settingColumn') }}</span>
    </template>
    <Popover
    ...
    >
      <template #title>
        <div :class="`${prefixCls}__popover-title`">
          ...
          >
            {{ t('sys.component.table.settingColumnShow') }}
          </Checkbox>

          <Checkbox v-model:checked="checkIndex" @change="handleIndexCheckChange">
            {{ t('sys.component.table.settingIndexColumnShow') }}
          </Checkbox>
          ...
          >
            {{ t('sys.component.table.settingSelectColumnShow') }}
          </Checkbox>
          ...
          <CheckboxGroup v-model:value="checkedList" @change="onChange" ref="columnListRef">
            <template v-for="item in plainOptions" :key="item.value">
              <div :class="`${prefixCls}__check-item`" v-if="!('ifShow' in item && !item.ifShow)">
                ...
                >
                  <template #title>
                    {{ t('sys.component.table.settingFixedLeft') }}
                  </template>
                  <Icon
                ...
                >
                  <template #title>
                    {{ t('sys.component.table.settingFixedRight') }}
                  </template>
                  <Icon
                    icon="line-md:arrow-align-left"
                    :class="[
