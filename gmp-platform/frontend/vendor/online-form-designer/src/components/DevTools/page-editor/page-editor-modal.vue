...
<script setup lang="ts" name="page-editor-modal">
  ...
  const ns = useNamespace('page-editor-modall');

  const props = defineProps<{
    pageJson: IData;
  }>();

  const originStr = valueTransfer.valueToStr(props.pageJson);
