...
<script lang="ts" setup>
  ...
  const toolbarList = computed(() => {
    ...
    const defaultToolbarList = [
      { label: t('sys.component.tree.expandAll'), value: ToolbarEnum.EXPAND_ALL },
      {
        label: t('sys.component.tree.unExpandAll'),
    ...
    return checkable
      ? [
          { label: t('sys.component.tree.selectAll'), value: ToolbarEnum.SELECT_ALL },
          {
            label: t('sys.component.tree.unSelectAll'),
            value: ToolbarEnum.UN_SELECT_ALL,
            divider: checkable,
          },
          ...defaultToolbarList,
          { label: t('sys.component.tree.checkStrictly'), value: ToolbarEnum.CHECK_STRICTLY },
          { label: t('sys.component.tree.checkUnStrictly'), value: ToolbarEnum.CHECK_UN_STRICTLY },
        ]
      : defaultToolbarList;
  });
