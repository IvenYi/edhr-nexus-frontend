...
import './vue3-dnd-item-hover-title.css';

export const Vue3DndItemHoverTitle = defineComponent({
  name: 'Vue3DndItemHoverTitle',
  props: {
    top: {
      type: Number,
      default: 0,
  ...
  setup(props) {
    const ns = useNamespace('vue3-dnd-item-hover-title');
