...
<script setup lang="ts" name="gct-container-combine-designer">
  ...
  const rightColumns = computed(() => {
    ...
    const combineDetailCols = [
      { title: '待合并数量', dataIndex: 'combine_qty_', key: 'combine_qty_' },
      { title: '数量为0关闭', dataIndex: 'close_when_empty_', key: 'close_when_empty_' }
    ]
    return columns.concat(combineDetailCols);
  });
</script>
