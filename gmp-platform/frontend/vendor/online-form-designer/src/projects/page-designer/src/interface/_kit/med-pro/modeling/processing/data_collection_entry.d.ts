...
interface DataCollectionEntry extends CommonFields {
  /**
   * 排序号
   *
   * @author zyl
...
/**
 *模型名称：数据采集项
 *模型KEY:em_data_collection_entry
 */
interface DataCollectionEntryMethods extends IModelService<DataCollectionEntry> {
}
