...
export const widget: BaseButton = {
  ...
  name: 'sys.pageDesigner.modelingTraceability',
  alias: '',
  type: FormComponents.ModelingButton,
  icon: 'icon-jianmozhuisu',
  display: DisplayEnums.INLINE_BLOCK,
  children: [],
  props: {
    ...baseBtnProp,
    title: '${sys.pageDesigner.modelingTraceability}',
    icon: 'icon-park:six-points',
  },
  style: {},
  events: {},
  formItem: false,
...
export const propEditorList: LowCodeWidget.PropEditor[] = [
  {
    ...
    _config: {
      ...
      maxlength: 10,
      showCount: true,
      defaultValue: 'sys.pageDesigner.modelingTraceability'
    },
  },
  ...displayEditor,
  ...buttonEditor,
