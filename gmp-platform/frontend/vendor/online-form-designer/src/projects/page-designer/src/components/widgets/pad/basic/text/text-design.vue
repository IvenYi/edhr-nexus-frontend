...
<script setup lang="ts" name="gct-text">
  ...
  const style = computed(() => {
    ...
    return {
      ...
      borderTopRightRadius: `${styleProp.borderTopRightRadius || 4}px !important`,
      borderTopLeftRadius: `${styleProp.borderTopLeftRadius || 4}px !important`,
      borderBottomRightRadius: `${styleProp.borderBottomRightRadius || 4}px !important`,
      borderBottomLeftRadius: `${styleProp.borderBottomLeftRadius || 4}px !important`,
