...
export const useTableLayout = (tableBoxRef: Ref, widget: DataTable, parentWidget) => {
  ...
  const showBoxScroll =
    Event.pageLayoutMode === pageLayoutModeEnum.SHOW_BOX_SCROLL && !parentWidget;
  //autoResize  兼容edhr表格老版本逻辑
  const autoResize = widget.props.autoResize || showBoxScroll;
