<template>
  <div v-if="widget.props.model" class="gct-crad-list" :style="styleWrap">
    <div class="gct-card-item">
      ...
      <div class="gct-card-container gct-border-dashed" :class="{ 'w-full': !rowSelection }">
        <div class="gct-card-content">
          <div v-if="showTitle" class="gct-card-header">
            <van-row :gutter="10">
              <van-col span="12" class="gct-card-header-left header-item" :style="headerStyleAttr">
                <drag-widget-group
                  v-if="!isNewDesigner"
                  :parent-drag-widgets="children[0].children"
                  :parentWidget="widget"
              ...
              >
                ...
                >
                  <drag-widget-group
                    v-if="!isNewDesigner"
                    :parent-drag-widgets="children[1].children"
                    :parentWidget="widget"
                    showPlaceholder
                    :placeholderText="$t('sys.pageDesigner.dragFieldHere')"
                    @add="handleDragAdded"
          ...
          <div class="gct-card-main" :style="styleAttr">
            ...
            >
              <drag-widget-group
                v-if="!isNewDesigner"
                :parent-drag-widgets="children[2].children"
                :parentWidget="widget"
                showPlaceholder
                :placeholderText="$t('sys.pageDesigner.dragFieldHere')"
                @add="handleDrag"
        ...
        <div v-if="draggable || children[3].children!.length" class="gct-card-footer">
          ...
          <div style="flex: 1">
            <!-- <cardBtn
              ...
              :visibleButtons="props.widget.props.visibleButtons"
            /> -->
            <tableButtons
...
<script setup lang="ts" name="card-list-design">
  ...
  const styleAttr = computed(() => {
    ...
    return {
      ...
      paddingLeft: (style.paddingLeft || 0) + 'px',
      minHeight: (style.height ? style.height - 44 : 127) + 'px',
    };
  });
