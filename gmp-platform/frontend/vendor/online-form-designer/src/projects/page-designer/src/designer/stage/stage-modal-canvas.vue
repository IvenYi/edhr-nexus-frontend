<template>
  <div class="design-modal-canvas">
    ...
    <div
      ...
      :class="{
        'modal-canvas': !isDrawer,
        'drawer-canvas': isDrawer,
...
<script setup lang="ts">
  import { useDesigner, isNewDesigner, useDesignerController } from '/@page-designer/hooks/useDesigner';
  ...
  const isDrawer = computed(() => {
    return modalInfo.value?.props?.openMode === 'drawer';
  });
  ...
  onMounted(() => {
    if (!modalInfo.value?.props?.openMode) {
      modalInfo.value.props.openMode = 'modal';
    }
  });
