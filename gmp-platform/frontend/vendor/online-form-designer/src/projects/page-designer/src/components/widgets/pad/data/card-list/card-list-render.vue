<template>
  <van-list
    ...
    :offset="10"
    @load="onload"
    :immediate-check="computedInitLoad"
    :loading="loading"
    class="p16px"
  >
    <!-- 用于单选时的容器 -->
        ...
        <div :style="styleWrap">
          ...
          >
            ...
            <div class="gct-card-content">
              ...
              <div v-if="children[3].children!.length" class="gct-card-footer">
...
<script setup lang="ts" name="card-list-render">
  ...
  import { RenderTableColunmButtons } from '../data-table/component/render-table-buttons/render-table-column-buttons';
