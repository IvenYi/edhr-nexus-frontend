      ...
      <template #input>
        ...
        >
          <div class="gen-image__con">
            <van-image
              :loading-icon="imageSrc"
              v-show="autoWidth"
              width="100%"
              :height="imageUrl ? 'auto' : widget.props.maxHeight"
              :src="imageUrl"
              :style="{
                width: '100%',
                maxWidth:
                  imageUrl && widget.props.autoWidth
...
<script setup lang="ts" name="gct-gen-image">
  ...
  import imageSrc from '/@/assets/images/pic_image.png';
