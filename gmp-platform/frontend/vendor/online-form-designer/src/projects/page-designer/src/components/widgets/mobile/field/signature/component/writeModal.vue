  ...
  >
    <div class="wacom-wrap">
      ...
      <div class="mobile-render-content bg-[#FAFAFA] ks-column">
        <div ref="wacomRenderWrapRef" class="ks-col overflow-y-auto">
          <div
...
<script setup lang="ts">
  ...
  onMounted(() => {
    nextTick(() => {
      ...
      const maxH = wacomRenderWrapRef.value?.clientHeight - 20;
      const _height = Math.ceil((w * 9) / 16);
      wacomWidth.value = w;
      wacomHeight.value = Math.min(maxH, _height);
    });
  });
