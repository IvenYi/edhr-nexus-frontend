...
export default class MedProDeviceSelect implements IDesignerProvider {
  ...
  schema: IDeviceSelect = {
    ...
    name: '设备选择',
    alias: '',
    type: 'medpro' + KitType.DEVICE_SELECT,
  ...
  propEditors: LowCodeWidget.PropEditor[] = [
    ...
    },
    {
      ...
      _config: {
        ...
        options: async (widget) => {
          const serviceList = (await getBizServiceCrudList({ modelKey: widget.props.txnType })) ?? [];
    ...
    },
    {
      ...
      changeCallback: (widget: IDeviceSelect) => {
        widget.props.field = '';
    ...
    },
    {
      ...
      _config: {
        multiple: true,
        tips: '选择关联表单对应的工步字段，如有其他业务查询字段，可多选',
        modelKey: 'refFormModel',
        filterTypes: [CreateType.USER_DEFINED, CreateType.BUILTIN],
      },
