...
import { SearchBizProcess as ISearchBizProcess, Select } from '/@page-designer/types/web';
...
class SearchBizProcess extends BaseSearch {
  ...
  constructor() {
    super();
    this.name = 'sys.process.biz';
    this.type = SearchComponents.SearchBizProcess;
  ...
  static getInstance() {
    if (!this.instance) {
      this.instance = new SearchBizProcess();
    }
...
export const widget: ISearchBizProcess = SearchBizProcess.getInstance().getSearchWidget();

export const propEditorList: LowCodeWidget.PropEditor[] =
  SearchBizProcess.getInstance().getSearchPropEditor();
