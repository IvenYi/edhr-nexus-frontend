<template>
  <div
    v-if="!isNewDesigner"
    ref="btnContainerRef"
    class="button-container-design relative box-border overflow-visible"
  >
    <div
  ...
  <ButtonContainerDesign2 v-if="isNewDesigner === true" v-bind="props">
...
<script name="gct-button-container" setup lang="ts">
  ...
  import { ButtonContainer, SubTable } from '/@page-designer/types/web';
  ...
  import { ButtonSize, ButtonStyle } from '/@page-designer/enum';
