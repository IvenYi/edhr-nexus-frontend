  ...
  children: [
    {
      path: 'user',
      name: 'OrgUser',
      component: () => import('/@backend-management/views/user-manage/index.vue'),
      meta: {
    ...
    },
    {
      path: 'member',
      name: 'OrgMember',
      component: () => import('/@backend-management/views/org-member/index.vue'),
      meta: {
    ...
    },
    {
      path: 'seat',
      name: 'OrgSeat',
      component: () => import('/@backend-management/views/org-seat/index.vue'),
      meta: {
