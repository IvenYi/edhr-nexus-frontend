...
const basicAttrsUtils = {
  required: [
    ...
    },
    {
      ...
      transform: (value) => $t('sys.appDesigner.value'),
    },
    {
      from: '_',
...
export const DynCompUtils: IDynCompUtils = {
    ...
    attrsTransform: [
      ...
      ...basicAttrsUtils.showType,
      {
        ...
        transform: (value, fieldType: FIELD_TYPE, rowFormData) => {
          return [
            {
              label: rowFormData.true_text_ || $t('sys.real'),
              value: true,
              refFields: [],
              _item: {},
            },
            {
              label: rowFormData.false_text_ || $t('sys.fake'),
              value: false,
              refFields: [],
              _item: {},
            },
  ...
  [DYN_F_TYPE.ATTACHMENT]: {
    infValKey: 'attachment_value_',
