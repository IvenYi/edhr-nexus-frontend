<template>
  <CheckboxGroup
    ...
    :class="['switch-checkbox-group', isAutoLineBreak && 'switch-checkbox-group--auto-line-break']"
  >
...
<script setup lang="ts" name="CheckboxSwitch">
  ...
  const currentValue = computed({
    ...
    set(value) {
      const bool = last(value);
      if (isNil(bool)) {
        emit('update:value', null);
        return;
      }

      emit('update:value', typeof bool !== 'boolean' ? Boolean(bool) : !!bool);
    },
  });
</script>
