...
export const ReceiptModal = defineComponent({
  ...
  setup(props) {
    ...
    const isNewVersion = computed(() => !!props.context?.handlerType);

    console.log('receipt-modal', props);
    ...
    if (isNew.value) {
      footerActions.splice(1, 0, {
        text: t('sys.appDesigner.excelImportConfirmation'),
        props: {
          type: 'primary',
        },
        onClick: async (): Promise<void> => {
