  ...
  <a-form :model="formState">
    ...
    <SimpleCollapse :title="t('sys.appDesigner.approval.caseSetting')">
          ...
          <div class="flex items-center bg-[#F2F4F7] rounded-4px p8px mb-4px cursor-pointer">
            ...
            <div class="ks-col">
              <div class="mb4px ks-row-middle">
                ...
                <span class="text-[#8F8F8F]" v-if="node.type !== BpmnNodeTypeEnum.BpmnParallel">优先级 {{ index + 1 }}</span>
                <i
                  v-if="caseIfs.length > 1 && !paasBpmnReadonly&&node.type !== BpmnNodeTypeEnum.BpmnParallel"
      ...
      >
        ...
        <div class="mr4px text-[#8F8F8F]"  v-if="node.type !== BpmnNodeTypeEnum.BpmnParallel">优先级</div>
...
<script setup lang="ts">
  ...
  import { caseIfGenerator } from '@gct/flow/src/plugins/paas-bpmn/models/bpmnExclusive';
