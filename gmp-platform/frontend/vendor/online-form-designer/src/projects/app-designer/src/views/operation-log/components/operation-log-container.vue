...
<script setup lang="ts" name="operation-log-container">
  ...
  import type { DesignerOperateLogResponse } from '/@/apis/gct-apaas/model';
  ...
  const tableData = ref<Array<DesignerOperateLogResponse>>([]);
  const expand = ref<boolean>(false);

  const getTableData = async () => {
    const result = await getDesignerOperateLogPageList({
