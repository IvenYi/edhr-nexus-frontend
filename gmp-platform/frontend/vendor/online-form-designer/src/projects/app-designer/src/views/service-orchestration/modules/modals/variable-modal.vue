<template>
  ...
  >
    ...
    >
      ...
      <a-form-item :label="t('类型')" name="type" :rules="[{ required: true }]">
        <a-select
          :disabled="options.isEdit"
      ...
      <a-form-item
        v-if="
          [VariableTypeEnum.TEXT, VariableTypeEnum.NUMBER, VariableTypeEnum.BOOL].includes(
            formState.type!,
          )
        "
        :label="t('默认值')"
      ...
      >
        <a-input
          ...
          v-if="formState.type === VariableTypeEnum.TEXT"
        />
        <a-input-number
          v-model:value="formState.defaultValue"
        ...
        <a-select
          v-model:value="formState.defaultValue"
          v-if="formState.type === VariableTypeEnum.BOOL"
        >
