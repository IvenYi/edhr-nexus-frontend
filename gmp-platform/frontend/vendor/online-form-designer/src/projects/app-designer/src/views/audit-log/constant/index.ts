...
export enum BizModelTypeEnum {
  ...
  /** 参数列表 */
  DEVICE_INTERCONNECTION_PARAM = 'DEVICE_INTERCONNECTION_PARAM',
}
...
export const ModelTypeOptions = {
  ...
  TENANT: [
    ...
    {
      label: t('sys.menu.dataTrace'),
      value: BizModelTypeEnum.DATA_TRACE,
    },
    {
  ...
  DEVELOPER: [
    ...
    {
      label: t('sys.menu.deviceInterconnection'),
      value: BizModelTypeEnum.DEVICE_INTERCONNECTION,
    },
    {
      label: t('sys.appDesigner.printDesign.paramList'),
      value: BizModelTypeEnum.DEVICE_INTERCONNECTION_PARAM,
    },
    {
  ...
  APPFRONT: [
    ...
    {
      label: t('sys.appDesigner.biz_service'),
      value: BizModelTypeEnum.BIZ_SERVICE,
    },
  ],
  APPDESIGNER: [
    {
    ...
    {
      label: t('sys.appDesigner.permissionScope'),
      value: BizModelTypeEnum.PERMISSION_SCOPE,
    },
    {
    ...
    {
      label: t('sys.menu.sandbox'),
      value: BizModelTypeEnum.SANDBOX,
    },
    {
      label: t('sys.menu.operationLog'),
      value: BizModelTypeEnum.AUDIT_LOG,
...
export const AppDesignerOperateTypeOptions = {
  MODEL_DESIGN: [
    ...
    },
    {
      ...
      value: OperateTypeEnum.CLOSE,
    },
    {
      label: t('sys.open'),
      value: OperateTypeEnum.OPEN_ON,
    },
    {
      label: t('sys.APIConfig'),
      value: OperateTypeEnum.API_SETTING,
    },
  ],
  PERMISSION_SCOPE: [
    {
  ...
  SANDBOX: [
    ...
    {
      label: t('sys.synchronous'),
      value: OperateTypeEnum.SYNC,
    },
    {
      label: t('sys.delete'),
      value: OperateTypeEnum.DELETE,
