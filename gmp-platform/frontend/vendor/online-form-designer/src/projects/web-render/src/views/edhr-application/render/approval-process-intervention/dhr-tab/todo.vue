...
<script setup lang="ts">
  ...
  const columnDefinitions = [
    ...
    { title: t('sys.edhr.field.createUser'), field: 'approveHisCreateUserName', minWidth: 150 },
    { title: t('sys.edhr.field.createTime'), field: 'approveHisCreateTime', minWidth: 100 },
  ];
