...
<script setup lang="ts">
  ...
  const columnDefinitions = [
    ...
    { title: '编号', field: 'code', minWidth: 200 },
    { title: '产品家族', field: 'productFamilyName', minWidth: 200 },
    { title: '产品编码', field: 'productCode', minWidth: 200 },
    { title: '产品名称', field: 'productName', minWidth: 200 },
    { title: '规格型号', field: 'productSpec', minWidth: 200 },
    {
      title: '生产模式',
    ...
    { title: '处理人', field: 'assigneeName', minWidth: 120 },
