<template>
            ...
            <template v-if="formState.type === 'password'">
              ...
              >
                ...
                <van-row :gutter="20" justify="end" class="mr10px">
                  ...
                  <van-col
                    v-if="
                      signGroup.hasCounterSignGroup && signGroup.counterSignNumber && !sign.validate && !sign.isShowCountersigns
                    "
                    ><van-button
                      size="small"
                      type="primary"
  ...
  <van-popup v-model:show="showCoSignPicker" position="bottom" teleport="body">
    <van-picker
      v-model="pickerVal"
      :columns="options"
