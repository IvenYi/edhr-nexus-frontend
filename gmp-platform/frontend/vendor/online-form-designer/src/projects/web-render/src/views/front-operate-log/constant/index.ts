...
export const OperateTypeOptions: SelectProps['options'] = [
  ...
  {
    label: t('sys.appDesigner.saveOrUpdate'),
    value: OperateTypeEnum.SAVE_OR_UPDATE,
  },
];
...
export const BizModelTypeOptions: SelectProps['options'] = [
  ...
  {
    label: t('sys.menu.mobileApplicationHomepage'),
  ...
  {
    label: t('sys.appDesigner.formTask'),
    value: BizModelTypeEnum.FORM_TASK,
  },
];
