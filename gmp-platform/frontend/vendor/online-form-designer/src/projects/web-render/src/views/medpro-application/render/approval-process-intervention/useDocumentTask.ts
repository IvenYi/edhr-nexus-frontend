...
const initialTabs = computed(() => [
  {
    key: 'doc',
    name: t('表单流程'),
    visible: enableDoc && userActions.value.Doc,
    component: DocTab,
  },
  {
    key: 'tmpl',
    name: t('模板审核'),
    visible: enableDocControl && userActions.value.Tmpl,
    component: ControlTab,
  },
  {
    key: 'routing',
    name: t('工艺审核'),
    visible: enableRoutingApprove && userActions.value.Routing,
    component: RoutingTab,
  },
  {
    key: 'productProcess',
    name: t('制程审核'),
    visible: enableProductProcessApprove && userActions.value.ProductProcess,
    component: ProductProcessTab,
  },
  {
    key: 'dhr',
    name: t('DHR审核'),
    visible: !dhrSumDisabled && userActions.value.Dhr,
    component: DhrTab,
  },
  {
    key: 'change',
