...
<script setup lang="ts">
  ...
  const initSearchList = [
    ...
    {
      type: 'dateRange2',
      label: t('sys.message.timeRanges'),
      required: true,
      id: 'pushTime',
      model: 'pushTime',
  ...
  const columnDefinitions = [
    { title: t('sys.message.templateKey'), field: 'tmplKey', minWidth: 300 },
    { title: t('sys.message.templateName'), field: 'tmplName', minWidth: 300 },
    ...
    { title: t('sys.integration.receiveUser'), field: 'userName' },
    { title: t('sys.message.pushTime'), field: 'pushTime', minWidth: 170 },
  ];
