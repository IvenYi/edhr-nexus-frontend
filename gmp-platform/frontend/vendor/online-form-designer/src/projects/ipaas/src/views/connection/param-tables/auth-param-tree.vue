...
<script lang="ts" setup name="json-tree-editor">
  ...
  const KeyTypeAvailable = computed(() => {
    if (props.position === 'body') {
      return props.level === 0 ? [AuthKeyTypeEnum.Object, AuthKeyTypeEnum.Array] : Object.values(AuthKeyTypeEnum);
    } else {
