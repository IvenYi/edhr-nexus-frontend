...
export const GuideRoute: AppRouteRecordRaw ={
  path: '/guideDoc',
  name: 'guideDoc',
  meta: {},
  component: () => import('/@/views/sys/about/guide.vue'),
};
...
// 未经许可的基本路由
export const basicRoutes = [LoginRoute, RootRoute, GuideRoute, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, BI404Route, TenantRoute];
