...
export const PrintTypeOptions = [
  {
    ...
    label: '标签',
    icon: 'gct-iconfont icon-tab_biaoqian',
  },
  {
    code: PrintTypeEnum.RECEIPT,
    label: '单据',
    icon: 'gct-iconfont icon-tab_danju',
  },
];
...
export const ModuleKeyPrefix = {
  ...
  [ProcessTypeEnum.BUSINESS]: 'process',
...
export const moduleTabLabelEnum = {
  ...
  [CategoryEnum.WEB]: t('sys.newWebPage2'),
  ...
  [CategoryEnum.BUSINESS]: t('sys.newBizFlow'),
...
export const moduleTabSearchEnum = {
  ...
  [CategoryEnum.BUSINESS]: t('sys.searchFlow'),
