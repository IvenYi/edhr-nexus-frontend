...
import { ResponseEntityVoid, ResponseEntityFormRelateDTO, ResponseEntityListCategoryCompleteResponse, ResponseEntityListFormRelateDTO, ResponseEntityPageBaseOnlineFormModelMeta, ResponseEntityPageBaseFormRelateDTO } from './model/index';
...
export async function deleteFormRelateDeleteCategory(params: deleteFormRelateDeleteCategoryQueryInterface = {}, config = {}): Promise<ResponseEntityVoid['data']> {
...
export async function getFormRelateInfo(params: getFormRelateInfoQueryInterface = {}, config = {}): Promise<ResponseEntityFormRelateDTO['data']> {
  return defHttp.get(
    {
...
export async function getFormRelateListAllCategory(params: getFormRelateListAllCategoryQueryInterface = {}, config = {}): Promise<ResponseEntityListCategoryCompleteResponse['data']> {
  return defHttp.get(
    {
...
export async function getFormRelateListAllVersion(params: getFormRelateListAllVersionQueryInterface = {}, config = {}): Promise<ResponseEntityListFormRelateDTO['data']> {
  return defHttp.get(
    {
...
export async function getFormRelatePageListAllModelKey(params: getFormRelatePageListAllModelKeyQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseOnlineFormModelMeta['data']> {
  return defHttp.get(
    {
...
export async function getFormRelatePageListFormAppendChild(params: getFormRelatePageListFormAppendChildQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseFormRelateDTO['data']> {
  return defHttp.get(
    {
...
export async function getFormRelatePageListFormNoChild(params: getFormRelatePageListFormNoChildQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseFormRelateDTO['data']> {
  return defHttp.get(
    {
