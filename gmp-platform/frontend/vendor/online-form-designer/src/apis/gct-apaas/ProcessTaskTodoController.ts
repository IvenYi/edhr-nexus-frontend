...
import { ResponseEntityPageBaseProcessTaskTodoResponse, ProcessTaskApproveHisQueryRequest, ResponseEntityPageBaseProcessTaskTodoApproveHisResponse } from './model/index';
...
export async function getProcessTaskTodoAllUserPageList(params: getProcessTaskTodoAllUserPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseProcessTaskTodoResponse['data']> {
  return defHttp.get(
    {
 ...
 */
export async function postProcessTaskTodoApproveHisPageList(data: ProcessTaskApproveHisQueryRequest, config = {}): Promise<ResponseEntityPageBaseProcessTaskTodoApproveHisResponse['data']> {
  return defHttp.post(
    {
...
export async function getProcessTaskTodoPageList(params: getProcessTaskTodoPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseProcessTaskTodoResponse['data']> {
  return defHttp.get(
    {
