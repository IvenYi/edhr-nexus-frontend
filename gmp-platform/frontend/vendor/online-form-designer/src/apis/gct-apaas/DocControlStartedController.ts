...
import { ResponseEntityPageBaseDocControlStartedResponse, DocControlStartedRequest, ResponseEntitystring, ResponseEntityDocControlStartedResponse, ResponseEntityListDocControlStartedResponse } from './model/index';
...
export async function getDocControlStartedAllPageList(params: getDocControlStartedAllPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseDocControlStartedResponse['data']> {
  return defHttp.get(
    {
...
export async function putDocControlStartedEffectiveDateById(path: putDocControlStartedEffectiveDateByIdPathInterface, data: DocControlStartedRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.put(
    {
...
export async function getDocControlStartedInfo(params: getDocControlStartedInfoQueryInterface = {}, config = {}): Promise<ResponseEntityDocControlStartedResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocControlStartedList(params: getDocControlStartedListQueryInterface = {}, config = {}): Promise<ResponseEntityListDocControlStartedResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocControlStartedPageList(params: getDocControlStartedPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseDocControlStartedResponse['data']> {
  return defHttp.get(
    {
