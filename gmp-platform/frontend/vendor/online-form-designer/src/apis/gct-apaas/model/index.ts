...
export interface DataCollectionInstanceAbandonRequest {
  id?: string; // 表单实例Id
  reason?: string; // 作废原因
  signHistoryIds?: Array<string>; // 签名历史id集合
...
export interface DifyChatRequest {
  ...
  saleRecords?: Array<object>; // ERP mock数据
}
...
export interface EdhrInstanceQueryRequest {
  ...
  materialNos?: Array<string>; // 批次/SN数组
...
export interface ExcelColumnInfoV1 {
  ...
  numberFormats?: Array<integer>; // 数据字段导入格式
...
export interface ExcelTmplConfigV1 {
  ...
  duplicateKeyUpdate: Array<integer>; // 导入策略 0 仅新增（忽略重复数据）/1 新增及更新/2 仅更新数据
  modelKey?: string; // 模型key
...
export interface FormInstBomResponse {
  bomEntries?: Array<object>;
  formTmplBomList?: Array<object>;
  productionIdentificationId?: string;
  qty?: number;
  sequenceEntries?: Array<object>;
}
...
export interface ImportModelData {
  data?: Array<object>;
  dict?: object;
  hasPermissionFieldList?: Array<string>;
  sheetName?: string;
}
...
export interface ModelConstraint {
  ...
  fieldKeys?: Array<string>; // 约束字段
  fieldNames?: Array<string>; // 约束字段名称，前端回显用
...
export interface OnlineFormChangeHistoryRequest {
  ...
  reason: string; // 原因
  signHistoryIds: Array<string>; // 签名历史表id
...
export interface OnlineFormDesignDTO {
  ...
  formTmplBomList?: Array<object>; // 表单bom
...
export interface OnlineFormInsTaskRequest {
  ...
  relatedMaterialNos?: Array<string>; // 关联批次
  title?: string; // 任务标题
  tmplId?: string; // 表单模板ID
  tmplName?: string;
}
...
export interface OnlineFormInstance {
  ...
  recordNo?: string;
  relatedMaterialNos?: Array<string>;
  relationId?: string;
  resend?: number;
  runtimeJson?: string;
...
export interface ProcessTaskApproveHisQueryRequest {
  ...
  taskTypeList?: Array<string>; // 任务类型 集合
  title?: string; // 表单备注名
  tmplCode?: string; // 表单编号
  tmplId?: string; // 表单模板
  tmplName?: string; // 表单名称
  type?: string; // 审批流程记录类型
  typeList?: Array<string>; // 审批流程记录类型 集合
  version?: string; // 版本
}
...
export interface QueryForeignFieldsRequest {
  exp?: string;
  foreignFields?: Array<string>; // 钻取字段 ["f1.f2.f3","f4.f5"
  modelKey: string; // 模型key
  pageNo?: number;
  pageSize?: number;
  query?: object;
...
export interface SubModelProps {
  foreignFields?: Array<string>; // 子表钻取字段 ["f1.f2.f3","f4.f5"
