...
import { DocumentRequest, ResponseEntitystring, DocumentDTO, ResponseEntityDocumentResponse, ResponseEntityListDocumentResponse, ResponseEntityPageBaseDocumentResponse } from './model/index';

/**
 * 保存
 * import { postDocument } from "/@/apis/gct-apaas/DocumentController"
 */
export async function postDocument(data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.post(
    {
...
export async function deleteDocument(params: deleteDocumentQueryInterface = {}, config = {}): Promise<ResponseEntitystring['data']> {
 ...
 */
export async function postDocumentCopy(data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.post(
    {
...
export async function postDocumentCopyVersionById(path: postDocumentCopyVersionByIdPathInterface, data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.post(
    {
...
export async function putDocumentDesignById(path: putDocumentDesignByIdPathInterface, data: DocumentDTO, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.put(
    {
 ...
 */
export async function getDocumentDocumentDataClean(config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.get(
    {
...
export async function getDocumentGetVersionById(params: getDocumentGetVersionByIdQueryInterface = {}, config = {}): Promise<ResponseEntityDocumentResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocumentInfo(params: getDocumentInfoQueryInterface = {}, config = {}): Promise<ResponseEntityDocumentResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocumentList(params: getDocumentListQueryInterface = {}, config = {}): Promise<ResponseEntityListDocumentResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocumentListVersionById(params: getDocumentListVersionByIdQueryInterface = {}, config = {}): Promise<ResponseEntityListDocumentResponse['data']> {
  return defHttp.get(
    {
...
export async function getDocumentPageList(params: getDocumentPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseDocumentResponse['data']> {
  return defHttp.get(
    {
...
export async function deleteDocumentRemoveVersionById(params: deleteDocumentRemoveVersionByIdQueryInterface = {}, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.delete(
    {
 ...
 */
export async function postDocumentSaveVersion(data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.post(
    {
...
export async function putDocumentUpdateVersionByIdById(path: putDocumentUpdateVersionByIdByIdPathInterface, data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.put(
    {
...
export async function putDocumentById(path: putDocumentByIdPathInterface, data: DocumentRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.put(
    {
