...
/**
 * 删除
 * import { deleteRegexp } from "/@/apis/gct-apaas/RegexpController"
 */
...
/**
 * 详情
 * import { getRegexpInfo } from "/@/apis/gct-apaas/RegexpController"
 */
...
/**
 * 分页列表
 * import { getRegexpPageList } from "/@/apis/gct-apaas/RegexpController"
 */
...
export async function getRegexpPageList(params: getRegexpPageListQueryInterface = {}, config = {}): Promise<ResponseEntityPageBaseRegexpResponse['data']> {
  return defHttp.get(
    {
      url: `/gct-apaas/api/regexp/page/list`,
      params,
    },
    {
      joinTenantIdToHeader: true,
...
/**
 * 修改
 * import { putRegexpById } from "/@/apis/gct-apaas/RegexpController"
 */
...
export async function putRegexpById(path: putRegexpByIdPathInterface, data: RegexpRequest, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.put(
    {
      url: `/gct-apaas/api/regexp/${path?.id}`,
      data,
    },
    {
      joinTenantIdToHeader: true,
