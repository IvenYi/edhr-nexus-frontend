...
/**
 * 获取 app的被共享应用
 * import { getAppGetDestBySourceExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export interface getAppGetDestBySourceExternalQueryInterface {
  appId: string; // appId
}
export async function getAppGetDestBySourceExternal(params: getAppGetDestBySourceExternalQueryInterface = {}, config = {}): Promise<ResponseEntityListstring['data']> {
  return defHttp.get(
    {
...
/**
 * 获取 app授权的源应用
 * import { getAppGetSourceByDestExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export interface getAppGetSourceByDestExternalQueryInterface {
  appId: string; // appId
}
export async function getAppGetSourceByDestExternal(params: getAppGetSourceByDestExternalQueryInterface = {}, config = {}): Promise<ResponseEntitystring['data']> {
  return defHttp.get(
    {
...
/**
 * 获取 appId 下授权用户
 * import { getAppListAppGrantedUserIdExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 锁定解锁应用
 * import { postAppLockOrUnlockToPaasExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询已发布生产环境的应用
 * import { getAppProdPublishedExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export async function getAppProdPublishedExternal(config = {}): Promise<ResponseEntitySetstring['data']> {
  return defHttp.get(
    {
...
/**
 * 查询已发布应用
 * import { getAppPublishedExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询已发布验证环境的应用
 * import { getAppTestPublishedExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export async function getAppTestPublishedExternal(config = {}): Promise<ResponseEntitySetstring['data']> {
  return defHttp.get(
    {
 ...
 * import { postAppUpdateApaasAppSettingExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询数据-iPaaS
 * import { getDataSourceExecuteSelectExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export interface getDataSourceExecuteSelectExternalQueryInterface {
  env: string; // env
  key: string; // key
  sql: string; // sql
}
export async function getDataSourceExecuteSelectExternal(params: getDataSourceExecuteSelectExternalQueryInterface = {}, config = {}): Promise<ResponseEntityListMap['data']> {
  return defHttp.get(
    {
...
/**
 * 执行DML、DDL-iPaaS
 * import { postDataSourceExecuteUpdateExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export async function postDataSourceExecuteUpdateExternal(data: DataSourceUpdateRequest, config = {}): Promise<ResponseEntityint['data']> {
  return defHttp.post(
    {
...
/**
 * 根据key和env查询数据源
 * import { getDataSourceFindByKeyAndEnvExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export interface getDataSourceFindByKeyAndEnvExternalQueryInterface {
  env: string; // env
  key: string; // key
}
export async function getDataSourceFindByKeyAndEnvExternal(params: getDataSourceFindByKeyAndEnvExternalQueryInterface = {}, config = {}): Promise<ResponseEntityDatasourceExtDTO['data']> {
  return defHttp.get(
    {
...
/**
 * 分页查询
 * import { postDataSourcePageListExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询数据
 * import { getDataSourceQueryDataExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询数据api
 * import { postDataSourceSelectExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询数据源类型
 * import { getDataSourceTypeExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
 ...
 * import { getMsgFindAllByTypeExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 测试发送邮箱消息
 * import { postMsgSendEmailMessageExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 测试发送企业微信、钉钉、飞书消息
 * import { postMsgSendMessageExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 根据部门id批量查询部门信息
 * import { postOrgFindAllByIdInExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 详情
 * import { getOrgInfoByIdExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
export interface getOrgInfoByIdExternalPathInterface {
  id: string; // id
}
export async function getOrgInfoByIdExternal(path: getOrgInfoByIdExternalPathInterface, config = {}): Promise<ResponseEntityOrg['data']> {
  return defHttp.get(
    {
...
/**
 * 根据机构名称全路径查询
 * import { postOrgListExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 根据机构名称全路径查询
 * import { getOrgListAllExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询部门负责人
 * import { postOrgPrincipalsExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 删除
 * import { deleteRegexpDeleteExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 详情
 * import { getRegexpInfoExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 列表
 * import { getRegexpListExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 分页列表
 * import { getRegexpPageListExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 保存
 * import { postRegexpSaveExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 修改
 * import { putRegexpUpdateByIdExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 根据域名或端口获取租户信息
 * import { getTenantInfoByPortOrDomainExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 根据机构名称全路径查询
 * import { getTenantOrgListExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 从第三方同步用户
 * import { postTenantUserSyncFromThirdPartyExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 查询人员所在主部门,部门主管
 * import { getUserOrgPrincipalExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
...
/**
 * 批量查询人员所在主部门,部门主管
 * import { postUserOrgPrincipalsExternal } from "/@/apis/gct-platform/ExternalRegexpController"
 */
