...
import { ResponseEntitystring, I18nInfo, ResponseEntityobject, ResponseEntityPageBaseI18nInfoResponse, I18nInfoRequest } from './model/index';
 ...
 */
export async function postI18nInfoExternalLangSync(data: I18nInfo[], config = {}): Promise<ResponseEntityobject['data']> {
  return defHttp.post(
    {
...
export async function postI18nInfoLangJson(data: any, params: postI18nInfoLangJsonQueryInterface = {}, config = {}): Promise<ResponseEntityobject['data']> {
  return defHttp.post(
    {
...
export async function postI18nInfoLangTrans(data: any, params: postI18nInfoLangTransQueryInterface = {}, config = {}): Promise<ResponseEntityobject['data']> {
  return defHttp.post(
    {
