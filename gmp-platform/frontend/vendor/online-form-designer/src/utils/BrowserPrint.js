...
$jscomp.polyfill = function (e, g, k, h) {
  if (g) {
    ...
    g != h &&
      null != g &&
      $jscomp.defineProperty(k, e, { configurable: !0, writable: !0, value: g });
  }
};
$jscomp.polyfill(
...
var BrowserPrint = (function () {
  ...
  function g(a, c, b, d) {
    void 0 !== a &&
      (void 0 === b && (b = a.sendFinishedCallback), void 0 === d && (d = a.sendErrorCallback));
    return h(c, b, d);
  }
  function k(a, c, b) {
    ...
    a.onreadystatechange = function () {
      a.readyState === XMLHttpRequest.DONE && 200 === a.status
        ...
        : a.readyState === XMLHttpRequest.DONE &&
          (b ? b(a.response) : console.log('error occurred with no errorCallback set.'));
    };
    return a;
  }
  var f = {},
  ...
  f.Device = function (a) {
    ...
    this.read = function (b, a) {
      ...
      d &&
        (void 0 !== c &&
          (void 0 === b && (b = c.readFinishedCallback), void 0 === a && (a = c.readErrorCallback)),
        h(d, b, a),
        d.send(
          JSON.stringify({
            device: {
      ...
      ((finishedFunction = function (c) {
        ...
        for (var d in response)
          if (response.hasOwnProperty(d) && response[d].constructor === Array)
            for (arr = response[d], c = 0; c < arr.length; ++c) arr[c] = new f.Device(arr[c]);
        void 0 === b
          ? a(response)
  ...
  f.getDefaultDevice = function (a, c, b) {
    ...
    if ((a = e('GET', m + d)))
      (finishedFunction = function (a) {
        ...
        '' === response
          ? c(null)
          : ((response = JSON.parse(response)), (a = new f.Device(response)), c(a));
      }),
